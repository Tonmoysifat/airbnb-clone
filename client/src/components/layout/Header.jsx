        ...
        <>
            ...
            <div className="main-header border-b-[1px] border-solid pb-6 pl-10 pr-10 ">
                ...
                <div className="primary-header hidden z-0 md:flex flex-col w-full justify-center gap-5 items-center">
                    <div
                        className="flex w-full max-w-[850px] h-[66px] items-center rounded-full border-[1px] border-solid  shadow-lg">

                        <div className='flex-1 py-[14px] px-[32px] w-[282px] cursor-pointer'
                             onClick={() => document.getElementById('my_modal_2').showModal()}>
                            <div className="border-r-[1px] border-gray-[#80808054]">
                        ...
                        <div className="flex items-center">
                            <div className='flex-1 py-[14px] pr-[24px] w-[233px]'
                                 onClick={() => document.getElementById('my_modal_4').showModal()}>
                                <div className="font-medium text-sm">Who</div>
                                <div className='text-muted-foreground'>Add guests</div>
                            </div>
                            <div
                                className="mr-[9px] h-12 w-12 rounded-full bg-[#ff385c] flex justify-center items-center text-white">
                                <Search className="w-[17px] stroke-[3]"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="secondary-header hidden md:flex w-full justify-center">
                    <div
                        className="flex w-fit justify-between items-center gap-4 rounded-full border-[1px] border-solid pb-2 pl-6 pt-2 hover:shadow-lg">
                        <div className="font-medium cursor-pointer border-r-[1px] pr-3 border-gray-[#80808054]"
                        ...
                        <div
                            className="mr-3 aspect-square h-9 w-9 rounded-full bg-[#ff385c] flex justify-center items-center text-white">
                            <Search className="w-[17px] stroke-[3]"/>
                        </div>
                    </div>
                </div>
